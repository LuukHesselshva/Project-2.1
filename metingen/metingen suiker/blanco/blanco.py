...
os.chdir('C:\\Users\\luukj\\Documents\\GitHub\\Project-2.1\\metingen\\metingen suiker\\blanco')
...
df02 = read('blanco_2g')
df24 = read('blanco_2g4g')
df46 = read('blanco_4g6g')
df68 = read('blanco_6g8g')
df810 = read('blanco_8g10g')
